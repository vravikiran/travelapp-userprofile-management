...
public class Constants {
    ...
    public static final String appIdentifier = "travelapp-user-authentication";
    public static final String envIdentifier = "dev";
    public static final String profileIdentifier = "travelapp-user-authentication-config";
    public static final String DYNAMIC_PROPERTIES_SOURCE_NAME = "dynamicProperties";
